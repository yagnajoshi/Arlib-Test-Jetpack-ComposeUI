...
package com.arlib.compose.test.ui.signin
...
import com.arlib.compose.test.ui.signin.state.EmailState
import com.arlib.compose.test.ui.signin.state.EmailStateSaver
import com.arlib.compose.test.ui.signin.state.PasswordState
import com.arlib.compose.test.ui.signin.viewmodel.SignInViewModel
import com.arlib.compose.test.util.supportWideScreen
...
fun SignInScreen(
    ...
    val textStringToast by viewModel.oldOrNewUser.observeAsState()
    if(textStringToast.isNullOrEmpty().not()){
        mToast(context, textStringToast)
        viewModel.resetOldNewUserText()
    }
...
fun mToast(context: Context, textString: String?) {
